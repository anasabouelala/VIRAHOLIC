...
const Dashboard: React.FC<Props> = ({ data, businessName, onReset, geminiApiKey }) => {
    ...
    const renderOverview = () => (
        <div className="space-y-6 animate-slide-up">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-surface border border-zinc-800 rounded-xl p-6 flex flex-col items-center justify-center relative group shadow-lg">
                    ...
                    <div className="flex items-center gap-2 mb-4 z-20 relative">
                        ...
                        <div className="group/tooltip relative flex items-center justify-center">
                            ...
                            <div className="absolute bottom-full mt-2 w-64 p-3 bg-zinc-900 border border-zinc-700 rounded-lg text-xs text-zinc-300 opacity-0 group-hover/tooltip:opacity-100 transition-all pointer-events-none z-50 shadow-2xl hidden sm:block backdrop-blur-md">
                                <strong className="text-white block mb-1">What is this?</strong>
                                Your Generative Engine Optimization (GEO) Score measures how confidently major AI Search models (like our forensic AEO agent) will recommend your business based on data consistency, citations, visual trust, and sentiment.
                            </div>
                        </div>
                    </div>
                ...
                {/* Summary Card */}
                <div className="md:col-span-2 bg-surface border border-zinc-800 rounded-xl p-8 flex flex-col justify-center relative shadow-lg">
                    ...
                    <div className="flex items-center gap-2 mb-4 relative z-10">
                        ...
                        <div className="group/tooltip relative flex items-center justify-center ml-2">
                            ...
                            <div className="absolute bottom-full left-0 mb-2 w-64 p-3 bg-zinc-900 border border-zinc-700 rounded-lg text-xs text-zinc-300 opacity-0 group-hover/tooltip:opacity-100 transition-all pointer-events-none z-50 shadow-2xl hidden sm:block backdrop-blur-md">
            ...
            {data.marketOverview && (
                <div className="bg-surface border border-zinc-800 rounded-xl p-6 shadow-lg relative">
                    <div className="absolute inset-0 bg-gradient-to-r from-emerald-900/10 to-transparent pointer-events-none rounded-xl overflow-hidden"></div>
                    <div className="flex items-center gap-2 mb-6 relative z-10">
                        ...
                        <div className="group/tooltip relative flex items-center justify-center ml-2">
                            ...
                            <div className="absolute bottom-full left-0 mb-2 w-72 p-3 bg-zinc-900 border border-zinc-700 rounded-lg text-xs text-zinc-300 opacity-0 group-hover/tooltip:opacity-100 transition-all pointer-events-none z-50 shadow-2xl hidden sm:block backdrop-blur-md">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-surface border border-zinc-800 rounded-xl p-6 relative shadow-lg flex flex-col items-center justify-center">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <div className="group/tooltip relative flex items-center justify-center">
                            <AlertCircleIcon className="w-3.5 h-3.5 text-zinc-500 cursor-help hover:text-indigo-400 transition-colors" />
                            <div className="absolute bottom-full -left-1/2 transform translate-x-1/2 mb-2 w-64 p-3 bg-zinc-900 border border-zinc-700 rounded-lg text-xs text-zinc-300 opacity-0 group-hover/tooltip:opacity-100 transition-all pointer-events-none z-[60] shadow-2xl hidden sm:block backdrop-blur-md">
                ...
                <div className="lg:col-span-2 bg-surface border border-zinc-800 rounded-xl p-6 relative shadow-lg">
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <div className="group/tooltip relative flex items-center justify-center ml-2">
                            <AlertCircleIcon className="w-4 h-4 text-zinc-500 cursor-help hover:text-emerald-400 transition-colors" />
                            <div className="absolute bottom-full left-0 mb-2 w-72 p-3 bg-zinc-900 border border-zinc-700 rounded-lg text-xs text-zinc-300 opacity-0 group-hover/tooltip:opacity-100 transition-all pointer-events-none z-[60] shadow-2xl hidden sm:block backdrop-blur-md">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <div className="group/tooltip relative flex items-center justify-center ml-2">
                                    ...
                                    <div className="absolute bottom-full left-0 mb-2 w-72 p-3 bg-zinc-900 border border-zinc-700 rounded-lg text-xs text-zinc-300 opacity-0 group-hover/tooltip:opacity-100 transition-all pointer-events-none z-[60] shadow-2xl hidden sm:block backdrop-blur-md">
                                        ...
                                        Our AI agent automatically finds and analyzes your public Google Maps photos using a 3-layer AI chain. Each image goes through literal observation, then strategic scoring.
                                    </div>
                                </div>
                            </div>
                            <p className="text-zinc-400 leading-relaxed mb-6">
                                {isNotFound
                                    ...
                                    : 'Our agent auto-scanned your public Google Maps photos using a 3-layer vision chain: image discovery → literal inventory → strategic scoring.'}
                            </p>
                            ...
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <div className="group/tooltip relative flex items-center justify-center ml-2">
                                    ...
                                    <div className="absolute bottom-full left-0 mb-2 w-72 p-3 bg-zinc-900 border border-zinc-700 rounded-lg text-xs text-zinc-300 opacity-0 group-hover/tooltip:opacity-100 transition-all pointer-events-none z-50 shadow-2xl backdrop-blur-md hidden sm:block">
                                        <strong className="text-white block mb-1">Readiness Score</strong>
                                        Measures how easily voice assistants (Siri, Alexa, Google) can retrieve your business data. Relies on clean Google Business Profile status, Schema.org markup, and high-trust directory citations.
                                    </div>
                                </div>
                ...
                <div className="bg-surface border border-zinc-800 rounded-xl p-6 shadow-lg">
                    <div className="flex items-center gap-2 mb-6">
                        ...
                        <div className="group/tooltip relative flex items-center justify-center ml-1">
                            ...
                            <div className="absolute bottom-full left-0 mb-2 w-64 p-3 bg-zinc-900 border border-zinc-700 rounded-lg text-xs text-zinc-300 opacity-0 group-hover/tooltip:opacity-100 transition-all pointer-events-none z-50 shadow-2xl backdrop-blur-md hidden sm:block">What each voice assistant would actually say to a customer asking about this type of business in your location.</div>
                        </div>
                    </div>
    ...
    const renderMissions = () => {
        ...
        const allCompleted = missions.length > 0 && completedMissions.length === missions.length;
        
        // Elegantly maintain a cognitive load of exactly 3 uncompleted tasks:
        // By adding the number of completed tasks to our base of 3, 
        // we ensure there are always exactly 3 new tasks revealed (unless we reach the end of the array).
        const INITIAL_VISIBLE = 3;
        const visibleCount = Math.min(INITIAL_VISIBLE + completedMissions.length, missions.length);
                ...
                <div className="bg-surface border border-zinc-800 rounded-xl p-6 shadow-lg">
                    <div className="flex items-center justify-between mb-6">
                        <div className="flex items-center gap-2">
                            ...
                            <div className="group/tooltip relative flex items-center justify-center ml-2">
                                <AlertCircleIcon className="w-4 h-4 text-zinc-500 cursor-help hover:text-emerald-400 transition-colors" />
                                <div className="absolute bottom-full left-0 mb-2 w-64 p-3 bg-zinc-900 border border-zinc-700 rounded-lg text-xs text-zinc-300 opacity-0 group-hover/tooltip:opacity-100 transition-all pointer-events-none z-50 shadow-2xl backdrop-blur-md hidden sm:block">
                        ...
                        {allCompleted && (
                            <button 
                                onClick={() => setCompletedMissions([])}
                                className="text-[10px] font-bold text-emerald-400 bg-emerald-500/10 hover:bg-emerald-500/20 px-3 py-1.5 rounded-lg transition-colors border border-emerald-500/30 uppercase tracking-widest"
                            >
                                Reset Plan
                            </button>
                        )}
                        {!allCompleted && missions.length > 3 && (
                            <div className="text-[10px] text-zinc-500 font-mono">
                                TASK {completedMissions.length} OF {missions.length}
                            </div>
                        )}
                    </div>
                    
                    {allCompleted ? (
                        <div className="flex flex-col items-center justify-center p-8 bg-emerald-500/5 border border-emerald-500/20 rounded-xl text-center animate-fade-in">
                            <div className="w-16 h-16 bg-emerald-500/20 rounded-full flex items-center justify-center mb-4">
                                <CheckCircleIcon className="w-8 h-8 text-emerald-500" />
                            </div>
                            <h4 className="text-lg font-bold text-white mb-2 tracking-tight">Phase 1 Complete!</h4>
                            <p className="text-sm text-zinc-400 max-w-sm mb-6 leading-relaxed">You've successfully completed all recommended initialization tasks. To generate the next phase of advanced AEO strategies, please trigger a fresh audit.</p>
                            <button 
                                onClick={onReset}
                                className="px-6 py-2 bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold uppercase tracking-widest rounded-lg transition-colors"
                            >
                                Run Fresh Audit
                            </button>
                        </div>
    ...
    const renderCitations = () => (
        <div className="space-y-6 animate-slide-up">
            <div className="bg-surface border border-zinc-800 p-6 rounded-xl shadow-lg relative">
                ...
                <div className="flex items-center gap-2 mb-2 relative z-10">
                    ...
                    <div className="group/tooltip relative flex items-center justify-center ml-2">
                        <AlertCircleIcon className="w-4 h-4 text-zinc-500 cursor-help hover:text-indigo-400 transition-colors" />
                        <div className="absolute bottom-full left-0 mb-2 w-72 p-3 bg-zinc-900 border border-zinc-700 rounded-lg text-xs text-zinc-300 opacity-0 group-hover/tooltip:opacity-100 transition-all pointer-events-none z-[60] shadow-2xl backdrop-blur-md hidden sm:block">
    ...
    const renderStudio = () => (
        <div className="space-y-6 animate-slide-up">
            ...
            <div className="bg-surface border border-zinc-800 rounded-xl p-6 shadow-lg relative flex flex-col min-h-[500px]">
                <div className="absolute top-0 right-0 w-64 h-64 bg-indigo-500/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none"></div>
                    ...
                    <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-6 shadow-lg">
                        <div className="flex flex-col md:flex-row gap-8">
                            ...
                            <div className="w-full md:w-72 space-y-5">
                                ...
                                <div>
                                    <div className="flex items-center gap-2 mb-3">
                                        <h4 className="text-xs font-bold text-zinc-400 uppercase tracking-wider">Visibility by Intent</h4>
                                        <div className="group/tooltip relative flex items-center justify-center ml-2">
                                            <AlertCircleIcon className="w-3.5 h-3.5 text-zinc-500 cursor-help hover:text-indigo-400 transition-colors" />
                                            <div className="absolute bottom-full left-0 mb-2 w-64 p-3 bg-zinc-900 border border-zinc-700 rounded-lg text-xs text-zinc-300 opacity-0 group-hover/tooltip:opacity-100 transition-all pointer-events-none z-50 shadow-2xl backdrop-blur-md hidden sm:block">
                                                <strong className="text-white block mb-1">Search Intents</strong>
                                                How often your brand is the "Top Selection" when users vary their query intent from broad category searches to specific feature-driven prompts.
                                            </div>
                                        </div>
                                    </div>
