...
const ComparisonSection: React.FC = () => {
    return (
        <section id="comparison" aria-labelledby="comparison-heading" className="py-12 border-t border-white/5 animate-fade-in relative overflow-hidden backdrop-blur-3xl bg-black/40 rounded-[60px] my-8 mx-4 shadow-2xl">
            ...
            <div className="text-center mb-10 relative z-10 px-4">
                ...
                <h2 id="comparison-heading" className="text-4xl md:text-5xl font-bold text-white mb-4 tracking-tight uppercase">Specialist AEO vs Legacy SEO</h2>
            ...
            <div className="max-w-6xl mx-auto px-4 relative z-10 overflow-hidden">
                <div className="overflow-x-auto custom-scrollbar pb-6 rounded-[30px] border border-white/5">
                    <table className="w-full text-left border-collapse bg-zinc-950/20 backdrop-blur-xl overflow-hidden">
                        <caption className="sr-only">AEOHOLIC comparison with legacy SEO tools like SEMrush, Yext, and BrightLocal</caption>
                        <thead>
                            <tr className="bg-white/[0.03]">
                                <th scope="col" className="py-8 px-8 text-[11px] font-bold text-zinc-500 border-b border-white/5 uppercase tracking-widest w-1/3">Core Capability</th>
                                <th scope="col" className="py-8 px-8 text-[11px] font-black text-indigo-400 border-b border-white/10 uppercase tracking-widest bg-indigo-500/10 backdrop-blur-md text-center">AEOHOLIC</th>
                                <th scope="col" className="py-8 px-8 text-[11px] font-bold text-zinc-600 border-b border-white/5 uppercase tracking-widest text-center">SEMrush</th>
                                <th scope="col" className="py-8 px-8 text-[11px] font-bold text-zinc-600 border-b border-white/5 uppercase tracking-widest text-center">Yext</th>
                                <th scope="col" className="py-8 px-8 text-[11px] font-bold text-zinc-600 border-b border-white/5 uppercase tracking-widest text-center">BrightLocal</th>
                            </tr>
                        </thead>
